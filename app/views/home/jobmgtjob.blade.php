...
<head>
	...
	<script>
		function addRow() {
			Var =  '<tr><td><input type="text" name="job[]" id="job" placeholder="ชื่องาน"></td><td><input type="text" name="user[]" id="user" placeholder="จำนวนคน"></td><td><input type="text" name="female[]" id="female" placeholder="จำนวนสตรี"></td></tr>';
			$('#inputTable > tbody:last').append(Var);
